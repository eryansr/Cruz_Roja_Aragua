...
+function(a) {
    ...
    d.DEFAULTS= {
        toggle: !0, trigger: '[data-toggle="collapse"]'
    }
    ,
...
+function(a) {
    ...
    function b(b) {
        b&&3===b.which||(a(e).remove(), a(f).each(function() {
            ...
            ;
            e.hasClass("open")&&(e.trigger(b=a.Event("hide.bs.dropdown",
            f)),
            b.isDefaultPrevented()||(d.attr("aria-expanded",
            "false"),
            e.removeClass("open").trigger("hidden.bs.dropdown",
            f)))
        }
        ))
    }
    ...
    b).on("click.bs.dropdown.data-api",
    ".dropdown form",
    function(a) {
        a.stopPropagation()
    }
...
+function(a) {
    ...
    c.prototype.show=function() {
        ...
        if(this.hasContent()&&this.enabled) {
            ...
            var q=this.getCalculatedOffset(h,
            k,
            l,
            m);
